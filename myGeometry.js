/* Pseudocode:
Start
   declare variables: floatRectWidth, floatRectHeight, floatRectArea, FloatRectPerim, floatTriSide1, floatTriside2, floatTriside3, floatfloatTriArea, FloatTriPerim, floatRadius, floatCircleArea, floatCircleCircum;
   request user input for floatRectWidth, floatRectHeight, floatTriSide1, floatTriSide2, floatTriSide3, and floatRadius.   
   convert user input to dom input in JS
   create functions for floatRectArea, floatRectPerim, floatTriArea, floatTriPerim, floatCircleCircum
   calculate floatRectArea, floatRectPerim, floatTriArea, floatTriPerim, floatCircleCircum  by calling functions 
End*/
