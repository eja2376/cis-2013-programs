...
intGradeOption = parseInt(prompt("Enter grade option, either Audit pass/fail (1) or letter grade (2):"));

if (intGradeOption===1)
{
    if(floatTotalPts<=100 && floatTotalPts>=80)
        stringFinalGrade= "Pass";
    else stringFinalGrade= "Fail";
}
...
else stringFinalGrade = "Invalid Input";
